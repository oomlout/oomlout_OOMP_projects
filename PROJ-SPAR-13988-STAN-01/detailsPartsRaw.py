...
newPart.addTag('rawParts','"J1","EDGE-80PTH-RA","EDGE-80PTH-RA","VEC-127-080-R","Card edge connector (80 pin) for accepting a PCB with finger edge pins. This connector will accept the BBC micro:bit board.","CONN-13452",')
newPart.addTag('rawParts','"J2","M22PTH","M22PTH","1X22","Standard 22-pin 0.1" header","CONN-13453",')
